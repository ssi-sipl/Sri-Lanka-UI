...
export const Sidebar: React.FC<SidebarProps> = ({ mobileOpen, onClose }) => {
  ...
  icon: (
    <svg
      ...
      className="icon"
    >
      <path d="M4 7.75A2.75 2.75 0 0 1 6.75 5h1.34a1 1 0 0 0 .8-.4l.62-.82A2 2 0 0 1 11.1 3h1.8a2 2 0 0 1 1.59.78l.62.82a1 1 0 0 0 .8.4h1.34A2.75 2.75 0 0 1 20 7.75v8.5A2.75 2.75 0 0 1 17.25 19H6.75A2.75 2.75 0 0 1 4 16.25v-8.5ZM12 9a3.5 3.5 0 1 0 0 7 3.5 3.5 0 0 0 0-7Z" />
    </svg>
  )
}
  ];
